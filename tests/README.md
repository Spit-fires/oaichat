...
Run with coverage:
```bash
pytest --cov=clichat --cov-report=html
```
...
Tests use temporary directories for configuration and database files to avoid interfering with your actual clichat installation.
